...
import { initAdminDbConnection, initTenantDBConnection } from './initDBConnection';
import { getATenantRepo, getTenantsRepo } from '../repositories/tenant.js';
import { getCacheConnection, getCacheValuesArr, setCacheConnection } from './lruCacheManager';
...
export const connecAllDb = async () => {
